...
<div class="form-group" id="mial-message">
	...
	<div class="col-md-9 col-sm-9">
		<?php echo $form->textArea($model,'message_mail',array('rows'=>4, 'cols'=>50, 'class'=>'form-control')); ?>
...
<div class="form-group" id="facebook-message">
	...
	<div class="col-md-9 col-sm-9">
		<?php echo $form->textArea($model,'message_facebook',array('rows'=>4, 'cols'=>50, 'class'=>'form-control')); ?>
...
<div class="form-group" id="twitter-message">
	...
	<div class="col-md-9 col-sm-9">
		<?php echo $form->textArea($model,'message_twitter',array('rows'=>4, 'cols'=>50, 'class'=>'form-control')); ?>
...
<?php
    ...
    $cs->registerScriptFile(Yii::app()->request->baseUrl.'/js/general/SettingHelper.js');
?>