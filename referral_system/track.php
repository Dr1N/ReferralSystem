...
if($_SERVER['HTTP_HOST']=='referral_system'){
    ...
    $configFile=$webRoot.'/protected/config/local_track.php';
}
// Otherwise  switch off the debug mode and include the real configuration
    ...
    $configFile=$webRoot.'/protected/config/track.php';
}

$app = Yii::createWebApplication($configFile)->runSiteArea('track');